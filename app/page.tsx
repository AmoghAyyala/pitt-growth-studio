...
const serviceCards = [
  {
    ...
    text: 'Conversion-focused websites with hosting guidance, strong messaging, and clear paths to more calls and inquiries.',
    icon: Monitor,
  ...
  },
  {
    ...
    text: 'Google Ads, SEO, and AI-assisted keyword analytics working together to help your business get found and generate stronger leads.',
    icon: MousePointer2,
  ...
  const HomePage = () => (
    <>
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-slate-700 bg-slate-800 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  ...
                  <p className="mt-2 max-w-lg text-white/85">
                    Clean websites, dependable hosting support, and Google Ads + SEO informed by AI-assisted search analytics.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-6 space-y-5 text-slate-200">
                ...
                <div className="flex gap-3"><span className="mt-[10px] h-2 w-2 shrink-0 rounded-full bg-blue-400" /><p className="leading-7">We combine ad targeting, technical SEO, and AI/ML-assisted search term analysis so your budget supports both short-term lead flow and long-term visibility.</p></div>
                <div className="flex gap-3"><span className="mt-[10px] h-2 w-2 shrink-0 rounded-full bg-blue-400" /><p className="leading-7">We design websites, help with hosting setup, and make it easier for visitors to call, book, or reach out.</p></div>
      ...
      <section className="py-10 md:py-16">
        <Section>
          <div className="max-w-2xl">
            <h2 className="text-4xl font-semibold tracking-tight text-white">Before &amp; After</h2>
            <p className="mt-4 leading-7 text-slate-300">
              Real improvements we&apos;ve delivered for local Pittsburgh businesses.
            </p>
          </div>

          <div className="mt-10 grid gap-8 lg:grid-cols-3">
            {/* Website Improvement */}
            <div className="overflow-hidden rounded-[2rem] border border-slate-700 bg-slate-800/90 shadow-sm">
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&q=80"
                  alt="Outdated local business website on laptop"
                  className="h-48 w-full object-cover opacity-80"
                />
                <span className="absolute left-4 top-4 rounded-full bg-red-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">Before</span>
              </div>
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1547658719-da2b51169166?auto=format&fit=crop&w=800&q=80"
                  alt="Modern responsive business website on laptop"
                  className="h-48 w-full object-cover"
                />
                <span className="absolute left-4 top-4 rounded-full bg-emerald-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">After</span>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-semibold text-white">Website Redesign</h3>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Replaced an outdated, hard-to-navigate site with a fast, mobile-friendly design. Page load time dropped from 8s to under 2s and contact form submissions increased 3x.
                </p>
                <div className="mt-4 flex gap-3">
                  <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-xs font-semibold text-emerald-300">3x more leads</span>
                  <span className="rounded-full bg-blue-500/15 px-3 py-1 text-xs font-semibold text-blue-300">75% faster</span>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-slate-700 bg-slate-800/90 shadow-sm">
              <div className="relative">
                <img
                  ...
                  alt="Empty analytics dashboard with low traffic"
                  className="h-48 w-full object-cover opacity-80"
                />
                <span className="absolute left-4 top-4 rounded-full bg-red-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">Before</span>
              </div>
              <div className="relative">
                <img
                  ...
                  alt="Google Ads dashboard showing strong performance metrics"
                  className="h-48 w-full object-cover"
                />
                <span className="absolute left-4 top-4 rounded-full bg-emerald-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">After</span>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-semibold text-white">Google Ads + SEO</h3>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  A roofing company went from barely showing up on Google to ranking on page one for key local searches. Google Ads brought in qualified calls within the first week.
                </p>
                <div className="mt-4 flex gap-3">
                  <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-xs font-semibold text-emerald-300">Page 1 rankings</span>
                  <span className="rounded-full bg-orange-500/15 px-3 py-1 text-xs font-semibold text-orange-300">5x more calls</span>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-slate-700 bg-slate-800/90 shadow-sm">
              <div className="relative">
                <img
                  ...
                  alt="Business with few online reviews"
                  className="h-48 w-full object-cover opacity-80"
                />
                <span className="absolute left-4 top-4 rounded-full bg-red-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">Before</span>
              </div>
              <div className="relative">
                <img
                  ...
                  alt="Happy customer leaving a five-star review on phone"
                  className="h-48 w-full object-cover"
                />
                <span className="absolute left-4 top-4 rounded-full bg-emerald-500/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">After</span>
              </div>
              <div className="p-6">
                <h3 className="text-lg font-semibold text-white">Client Reviews Growth</h3>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  A med spa went from 12 Google reviews to over 80 in four months. A stronger online presence naturally encouraged more happy clients to leave feedback.
                </p>
                <div className="mt-4 flex gap-3">
                  <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-xs font-semibold text-emerald-300">12 → 80+ reviews</span>
                  <span className="rounded-full bg-amber-500/15 px-3 py-1 text-xs font-semibold text-amber-300">4.8★ average</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-slate-300">
              We&apos;ll review your current website, hosting setup, Google visibility, and lead flow, then recommend practical next steps based on what your business actually needs.
            </p>
            <div className="mt-8 space-y-4 text-slate-200">
              ...
              <div className="flex gap-3"><span className="mt-[10px] h-2 w-2 shrink-0 rounded-full bg-blue-400" /><p className="leading-7">We identify opportunities across Google Ads, SEO, hosting performance, and AI-assisted keyword targeting.</p></div>
      ...
      <section className="py-16 md:py-20">
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-slate-300">
              Have a question about your website, hosting, Google Ads + SEO strategy, or analytics setup? Reach out and we&apos;ll get back to you as soon as possible.
            </p>
